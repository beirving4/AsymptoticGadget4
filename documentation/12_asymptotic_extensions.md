...
This chapter describes products generated by AsymptoticGadget4. The
coordinated LOSS catalogue data record is a distinct, upstream-GADGET-4
product and therefore contains only the standard fields documented in
`18_loss_catalogue_data_dictionary.md`; it does not contain the custom fields
defined here.
